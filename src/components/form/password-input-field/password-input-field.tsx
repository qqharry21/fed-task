...
>({
  ...
  return (
    ...
    >
      <div
        className='password-rule-group'
        data-valid={passwordValidationResults.every((rule) => rule.isValid)}
      >
...
const PasswordVisibilityButton = React.memo(({ onClick }: { onClick: () => void }) => {
  return (
    <Button
      type='button'
      variant='ghost'
...
PasswordVisibilityButton.displayName = 'PasswordVisibilityButton';
